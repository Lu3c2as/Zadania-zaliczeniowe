...
//        boolean save5 = driver.findElement(By.xpath("//*[@id=\"main\"]/div[1]/div[2]/div[1]/div[2]/div/span[2]")).isDisplayed();//       Scanner sizeChoice = new Scanner(System.in);//      System.out.println("Wybierz rozmiar /n S /n M /n L /n XL");
